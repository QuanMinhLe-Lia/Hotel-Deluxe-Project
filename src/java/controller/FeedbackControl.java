...
public class FeedbackControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fbd.feedbackExists(bookingId)) {
            response.setContentType("text/plain");
            response.getWriter().write("Feedback already exists for this booking!");
            return;
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Create a Feedback object and set its properties for updating
        Feedback feedback = new Feedback();
