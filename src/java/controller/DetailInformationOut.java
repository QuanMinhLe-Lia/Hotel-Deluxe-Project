...
public class DetailInformationOut extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       ArrayList<Service> listSV = sd.getServiceByBookingID(bookingId);
       total=0;
    ...
    double discountrate = (100-temap)/100;     
        ...
        request.setAttribute("bookingDate", bk.getBookingDate().format(formatter));
        request.setAttribute("checkInDate", bk.getCheckInDate().format(formatter));
        request.setAttribute("checkOutDate", bk.getCheckOutDate().format(formatter));
